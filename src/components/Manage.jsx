...
export default function Manage() {
  ...
  return (
    <section className='relative mt-24 flex flex-col gap-[51px] md:flex-row md:gap-0 md:w-[77.25%] md:mx-auto lg:mt-[74px] xl:max-w-[1112px]'>
      <div className='relative z-30 w-[87.5%] mx-auto flex flex-col gap-3 md:basis-1/2 lg:w-full lg:gap-6'>
        ...
        <div className="hidden lg:block absolute -bottom-72 -left-[calc(100%_+_2.5rem)] bg-BrightRed/20 dark:bg-BrightRed/5 h-[436px] w-[832px] -rotate-45 rounded-full"></div>
        </div>
